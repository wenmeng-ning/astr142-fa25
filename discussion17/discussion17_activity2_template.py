...
if __name__ == "__main__":
    ...
    ### FIX ME: set other parameters from args as needed
    ### Save data and plots with filenames reflecting the input parameters
    r_traj = rk4_integration(q, m, r0, v0)
    plot_trajectory(r_traj, args.particle.capitalize())
